...
TACTICAL_ELO_SUITE = [
    ...
    ("r1b1kbnr/ppppqppp/2n5/4p3/4P3/5N2/PPPP1PPP/RNBQKB1R w KQkq - 2 3", ["b1c3", "d2d3", "f1c4", "d2d4", "b1a3"], 1150),
    ...
    # 1500 - 1700 ELO: Candidate Master Opening & Dynamic Motifs
    ("rnbqkbnr/pppp1ppp/4p3/8/4P3/8/PPPP1PPP/RNBQKBNR w KQkq - 0 2", ["d2d4"], 1500),
    ("rnbqkbnr/ppp1pppp/8/3p4/2PP4/8/PP2PPPP/RNBQKBNR b KQkq - 0 2", ["e7e6", "c7c6", "d5c4", "g8f6"], 1550),
    ("r1bqkb1r/ppp2ppp/2np1n2/1B2p3/4P3/5N2/PPPP1PPP/RNBQK2R b KQkq - 0 4", ["a7a6", "f8e7", "c8d7", "f6e4"], 1600),
    ("rnbqk2r/ppp1bppp/4pn2/3p4/2PP4/2N2N2/PP2PPPP/R1BQKB1R w KQkq - 2 5", ["c1g5", "c1f4", "c4d5", "e2e3", "f3e5"], 1650),
]
...
def estimate_elo_engine(engine, version_name="ChessFly"):
    ...
    # Performance rating calculation across the 850-1700 range
    estimated_rating = 800 + int(accuracy * 9.5)
